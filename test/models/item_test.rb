...
class ItemTest < ActiveSupport::TestCase
  ...
  test "recent returns items in correct order" do
    ...
    item_2 = create_item(created_on: 3.hour.ago)
    item_3 = create_item(created_on: 2.hour.ago)
  ...
  test "guid defaults to link" do
    ...
    item = create_item(guid: nil, link: link)
    assert_equal link, item.guid
  end
end
